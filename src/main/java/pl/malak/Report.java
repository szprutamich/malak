...
import pl.malak.sheets.Employer;
...
public class Report {
    ...
    private Map<String, Employer> employers = new TreeMap<>();
    ...
    private void addEmployer(String name, Employer employer) {
        employers.put(name, employer);
    }

    private Employer getEmployer(String name) {
        if (name == null) {
            return null;
        }
            ...
            for (int i = 0; i < sheetSize; i++) {
                ...
                switch (text) {
                    ...
                    case "CZĘŚĆ":
                        ...
                        break;
                    case "Lp.":
                        employer = new Employer(sheet);
                        addEmployer(employer.getEmployerName(), employer);
                        break;
                }
            }
